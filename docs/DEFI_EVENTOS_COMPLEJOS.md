...
Precisión técnica importante: el **art. 37.1.m LIRPF** —regla específica de futuros y opciones— se refiere solo a los mercados «regulados por el Real Decreto 1814/1991». Un perpetuo en un exchange cripto **no está en ese ámbito**; se le aplica la regla general de los arts. 33.1 y 34. La doctrina de referencia por analogía es la línea de consultas sobre CFD y forex: V0076-09, V0917-14, V0597-18, V2770-19, V0503-21, V2115-21, V0885-21. **RESUELTO el 20-8-2026 (revisión de derivados).** (a) El art. 33.1 califica y el 34 cuantifica, pero **la base la manda el art. 46.b)** y la compensación el 49.1.b) y 2; el flanco de la ausencia de transmisión lo cubren las **SSTS 803/2022 y 804/2022, de 21-6-2022**. (b) **IMPUTACIÓN DIARIA**: la V2115-21 —la consulta que quedaba pendiente— concluye que con liquidaciones periódicas la GyP se obtiene diariamente «aun cuando la posición contractual no se hubiese cerrado al finalizar dicho período impositivo» (art. 14.1.c), reiterada en V2788-21 y V3183-20. Un perpetuo liquida funding cada 8 h: una posición viva a 31-12 ya ha generado renta, y el registro necesita **un apunte por corte de liquidación**. (c) Gastos: comisiones de apertura y cierre sí; intereses **pagados** no; intereses **percibidos** sí. El *funding rate* no tiene doctrina: tesis prudente simétrica, anotado siempre por separado y con su signo. (d) **Un derivado sobre cripto no es un criptoactivo** (MiCA art. 2.4.a y considerando 9; Directrices ESMA marzo 2025): fuera del art. 37.1.h, del FIFO del 37.2 y de los modelos 172/173/721. (e) **El art. 33.5 no les alcanza** (V2770-19; precedente para futuros, V3755-16): el detector de recompra los deja fuera por construcción, con test propio. El art. 37.1.m sigue citando el **derogado** RD 1814/1991 (sucesión: RD 1282/2010 → RD 1464/2018 → **RD 814/2023**; remisión dinámica en la V0503-21). Se retira **V0917-14** de la línea de analogía: resolvía sobre el régimen de base general de 2013-2014, derogado desde 1-1-2015 por la Ley 16/2012. Aviso: todo esto es **analogía sin amparo del art. 89 LGT**, y el riesgo real es probatorio (**ECLI:ES:TSJAND:2023:18410**, 12-12-2023: 208.501 € de pérdidas en CFD rechazadas por falta de prueba).
...
| D1 | Derivados por diferencias | **LIQUIDACIÓN DE DERIVADO** (12.º tipo) | GP art. 33.1, base **art. 46.b)**; imputación **diaria** (V2115-21) | Ahorro | Línea CFD; **no** art. 37.1.m; **fuera** del 33.5 (V2770-19) y de MiCA |
